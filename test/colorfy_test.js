...
(function( exports ){
	...
	exports.constructor = {
		...
		file: function( test ) {
			test.equal( this.c.file, "test/files/bear.svg" );
			test.equal( this.c2.file, "test/files/bear.colors-blue-red.svg" );
			test.done();
		},
		...
		originalFilenameNoColor: function( test ) {
			test.equal( this.c.originalFilename, "test/files/bear.svg" );
			test.done();
		},

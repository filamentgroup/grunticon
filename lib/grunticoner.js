...
(function(exports) {
	...
	exports.render = function( imagedata , filename , pngRegex , svgRegex , isSvg , width , height , type , o) {
	...
	exports.processFile = function( filename , o ){
		...
		.then( function( data ){
			return self.render( imagedata , filename , pngRegex , svgRegex , isSvg , data.width, data.height , data.type , o );
		})
		.then( function( res ){
			promise.resolve( res );
		});

...
(function(exports) {
	...
	var getStats = function( imagedata , isSvg , filename , dir ){
	...
	var render = function( imagedata , filename , pngRegex , svgRegex , isSvg , width , height , type , o) {
	...
	exports.processFile = function( filename , o ){
		...
		getStats( imagedata , isSvg, filename , o.inputdir )
		.then( function( data ){
			return render( imagedata , filename , pngRegex , svgRegex , isSvg , data.width, data.height , data.type , o );
		})
		.then( function( res ){
			promise.resolve( res );
		});

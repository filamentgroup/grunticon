...
(function(exports) {
	...
	exports.writeCSS = function( dataarr , o ){
		...
		asyncCSS = [
			...
			'grunticon([',
			tab + '"' + path.join(basepath, o.datacss) +'",',
			tab + '"' + path.join(basepath, o.pngdatacss) +'",',
			tab + '"' + path.join(basepath, o.fallbackcss) +'"',
			']);'
		].join(newline)
		...
		filesnippet = [
			...
			"</script>",
			'<noscript>',
			tab + '<link href="' + path.join(basepath, o.fallbackcss) + '" rel="stylesheet">',
			'</noscript>'

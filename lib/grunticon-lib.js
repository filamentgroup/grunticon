...
(function(){
	...
	var defaults = {
		...
		files: {
			loader: path.join( __dirname, "..", "tasks", 'grunticon', 'static', 'grunticon.loader.js'),
			embed: path.join( __dirname, "..", "tasks", 'grunticon', 'static', 'grunticon.embed.js'),
			corsEmbed: path.join( __dirname, "..", "tasks", 'grunticon', 'static', 'grunticon.embed.cors.js'),
			banner: path.join( __dirname, "..", "tasks", 'grunticon', 'static', 'grunticon.loader.banner.js')
		},
